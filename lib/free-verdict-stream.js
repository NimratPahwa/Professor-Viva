...
function buildMockStreamSequence() {
  ...
  events.push({
    ...
    data: {
      ...
      total_score: 54,
      roast:
        "Quick read: the pain is real, people genuinely gather to complain about this. Then you walked in " +
        "wearing the exact same shirt as everyone already in the room. Your idea does not die because it is " +
        "bad, it dies because it is the forty-eighth. The one wedge still left open is in the full report. " +
        "Pivot the shape, keep the ambition.\n\n" +
