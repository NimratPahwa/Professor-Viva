...
function taskInstructions(verdict) {
  ...
  return [
    `The verdict is ${verdict}. Deliver it as ONE short narrative story of 70 to`,
    '100 words: connected sentences and a scene the reader can picture, not',
    'staccato fragments, no markdown headings, no bullet lists, no score numbers.',
    doorByVerdict[verdict],
    'Build the story from THIS idea\'s own evidence: its real competitor count, its',
    'actual demand findings, and its strongest and weakest scored dimensions. Two',
    'different ideas must never receive the same story. Every claim you make must',
    'trace to a fact in the evidence block. Do not restate the raw scores;',
    'translate what the evidence MEANS. Do not append a disclaimer or footer',
    'yourself; that is added afterward.'
  ].join('\n');
}
